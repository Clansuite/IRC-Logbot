...
?>
    <p>
     ...
     using the <a href="http://www.clansuite.com/">Clansuite IRC LogBot</a>.
    </p>
    ...
    <div class="rightsidebar rightpage rightpage1">
        ...
        <ul>
            ...
            <li><strong><a href="http://www.clansuite.com/documentation/">Dokumentation</a></strong></li>
            ...
            <li>
                ...
                <div style="text-align:center;width:120px;">
                    <a href="javascript:void(window.open('http://www.clansuite.com/livezilla/livezilla.php?intgroup=Q2xhbnN1aXRlLVN1cHBvcnQ=&amp;code=V2Vic2VpdGUgY2xhbnN1aXRlLmNvbQ__&amp;reset=true','','width=600,height=600,left=0,top=0,resizable=yes,menubar=no,location=no,status=yes,scrollbars=yes'))">
                        <img src="http://www.clansuite.com/livezilla/image.php?id=05" width="120" height="30" alt="LiveZilla Live Help" />
                    </a>
                    <noscript>
                        <div><a href="http://www.clansuite.com/livezilla/livezilla.php?intgroup=Q2xhbnN1aXRlLVN1cHBvcnQ=&amp;code=V2Vic2VpdGUgY2xhbnN1aXRlLmNvbQ__&amp;reset=true" target="_blank">Start Live Help Chat</a></div>
                    </noscript>
                </div>
                ...
                var script = document.createElement("script");script.type="text/javascript";var src = "http://www.clansuite.com/livezilla/server.php?request=track&output=jcrpt&nse="+Math.random();setTimeout("script.src=src;document.getElementById('livezilla_tracking').appendChild(script)",1);
                /* ]]> */</script>
    ...
    <div class="rightsidebar rightpage rightpage2">
        ...
        <ul>
            <li>
            <h2>Clansuite @ Twitter</h2>
            <a href="http://twitter.com/clansuite"><img alt="just a marketing moorhuhn" src="website/images/twitter-vogel.jpg" /></a>
            Jetzt Clansuite bei Twitter folgen, um noch schneller und direkter informiert zu werden!
            </li>
            </ul>
        </div>
        <!-- Ende Box1 -->
        ...
        <ul>
            ...
            <li><strong><a target="_blank" href="http://paste.clansuite.com/">Pastebin</a></strong></li>
    ...
    <div id="footer">
        ...
        <span id="footer-left" style="float:left; text-align:left; margin-top: -30px;">
            <a href="http://www.opensource.org/" target="_blank"><img style="opacity: 0.90;" src="website/images/banners/opensource-75x65-t.png" alt="OpenSource Logo" title="OpenSource Logo" /></a>
        </span>
        ...
        <span id="footer-right" style="float:right; text-align:right;">
            <a href="http://www.clansuite.com/banner/" target="_blank">
                <!--
                <img src="website/images/banners/powered_by_clansuite.png" alt="Clansuite 80x32 Logo" title="Clansuite Logo" />
                -->
                <img src="http://www.clansuite.com/website/images/banners/clansuite-crown-banner-80x31.png" alt="Clansuite 80x31 Crown Logo" title="Clansuite Logo" />
            </a>
        </span>
        </p>
    </div><!-- Fusszeile ENDE -->
